...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst URL = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/ooCKDNVhVwx5nuC5j8LT/reservations';\n\nconst postReservation = async (name, initDate, finalDate, idMeal) => {\n    console.log('hello from posting ' + idMeal + ' ' + Date())\n  const response = await fetch(URL, {\n    method: 'POST',\n    body: JSON.stringify({\n        item_id: idMeal,\n        username: name,\n        date_start: initDate,\n        date_end: finalDate,\n    }),\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8',\n    },\n  });\n  const data = await response.json();\n  return data;\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (postReservation);\n\n//# sourceURL=webpack://capstonemodule2/./src/modules/postReservation.js?");

/***/ }),

/***/ "./src/modules/reservationCard.js":
/*!****************************************!*\
  !*** ./src/modules/reservationCard.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _postReservation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./postReservation */ \"./src/modules/postReservation.js\");\n\n\nconst reservationCard = (title, tag, imageThumb, id, area) => {\n\n  const reservationBoard = document.querySelector('.reservation-board');\n\n  const imgThumb = document.createElement('img');\n  imgThumb.id = 'imgThumb';\n  imgThumb.src = imageThumb;\n\n  const form = document.createElement('form');\n\n  const divText = document.createElement('div');\n  const divTable = document.createElement('div');\n  divTable.className = 'divReservations';\n\n  if (!tag) {\n    tag = '';\n  }\n\n  divText.innerHTML = `<h2>${title}</h2><h4>${area} ${tag}</h4>`;\n\n  const inputName = document.createElement('input');\n  inputName.id = 'name';\n  inputName.className = 'remove';\n  inputName.placeholder = 'Your Name';\n  inputName.required = true;\n\n  const inputInitDate = document.createElement('input');\n  inputInitDate.id = 'initDate';\n  inputInitDate.placeholder = 'YYYY/MM/DD Initial Date ';\n  inputInitDate.required = true;\n  const inputFinalDate = document.createElement('input');\n  inputFinalDate.id = 'finalDate';\n  inputFinalDate.placeholder = 'YYYY/MM/DD Final Date'\n  inputFinalDate.required = true;\n  const submitButton = document.createElement('button');\n  submitButton.id = 'submit';\n  submitButton.textContent = 'SUBMIT';\n\n  const inputs = [inputName, inputInitDate, inputFinalDate, submitButton];\n\n  for (let i = 0; i < inputs.length; i += 1) {\n    form.appendChild(inputs[i]);\n  }\n\n  reservationBoard.appendChild(imgThumb);\n  reservationBoard.appendChild(divText);\n  divText.appendChild(form);\n  reservationBoard.appendChild(divTable);\n\n  form.addEventListener('submit', (event) => {\n    event.preventDefault();\n    const userName = document.getElementById('name');\n    const initDate = document.getElementById('initDate');\n    const finalDate = document.getElementById('finalDate');\n    (0,_postReservation__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(userName.value, initDate.value, finalDate.value, id);\n  });\n\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (reservationCard);\n\n//# sourceURL=webpack://capstonemodule2/./src/modules/reservationCard.js?");

/***/ }),

/***/ "./src/modules/reservationUI.js":
/*!**************************************!*\
  !*** ./src/modules/reservationUI.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _modules_getMeals_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/getMeals.js */ \"./src/modules/getMeals.js\");\n/* harmony import */ var _reservationCard_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reservationCard.js */ \"./src/modules/reservationCard.js\");\nconst URL = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/xJ4HvJykr7cdlrGqH18j/likes';\n\n\n\nconst reservationUI = async (idMeal) => {\n  const data = await (0,_modules_getMeals_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  data.meals.forEach((artWork) => {\n    if (artWork.idMeal === idMeal) {\n      (0,_reservationCard_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(artWork.strMeal, artWork.strTags, artWork.strMealThumb, artWork.idMeal, artWork.strArea);\n    };\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (reservationUI);\n\n//# sourceURL=webpack://capstonemodule2/./src/modules/reservationUI.js?");
